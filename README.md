...
Dữ liệu minh họa gồm 8 khách hàng từ ảnh mẫu và 7 ngưỡng quà. Hãy tạo hội nghị mới để sử dụng dữ liệu thực. Dữ liệu lưu tại localStorage của trình duyệt, không có máy chủ cơ sở dữ liệu, đăng nhập hoặc đồng bộ giữa thiết bị. Các tab trên cùng trình duyệt và cùng địa chỉ sẽ cập nhật khi dữ liệu được lưu. Nên tải bản sao lưu sau mỗi hội nghị. Chạy tại cùng địa chỉ để tiếp tục dùng dữ liệu đã lưu; bản mở trực tiếp và localhost có vùng lưu trữ riêng. Font Google Fonts có font hệ thống dự phòng khi không có Internet.
