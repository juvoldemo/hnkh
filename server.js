...
const files = {'/':'index.html','/index.html':'index.html','/style.css':'style.css','/app.js':'app.js','/advisors-data.js':'advisors-data.js','/advisor-picker.js':'advisor-picker.js','/cloud.js':'cloud.js','/xlsx-export.js':'xlsx-export.js','/logo.png':'logo.png'};
